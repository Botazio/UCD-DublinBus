...
# dependencies	
#	env variables - DJANGO_BACKEND (export DJANGO_BACKEND='/home/team13/UCD-DublinBus/backend'), AWS_MYSQL_PASSWORD 
...
# 0 0 * * * /home/team13/UCD-DublinBus/backend/dublinbus/scripts/setup_db.sh >> /home/team13/UCD-DublinBus/backend/dublinbus/scripts/setup_db.log 2>&1
...
GTFS_STATIC_DIR="${DJANGO_BACKEND}/dublinbus/scripts/gtfs_static"
...
sqlite3mysql --sqlite-file db.sqlite3 --mysql-user=admin --mysql-password="${AWS_MYSQL_PASSWORD}" --mysql-database=dublinbus --mysql-host=dublin-bus.caghf9c2wznv.eu-west-1.rds.amazonaws.com

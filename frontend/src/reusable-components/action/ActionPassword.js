...
// Component that handles the logic of the submission for changing the user password
const ActionPassword = (props) => {
   ...
   return (
      <>
         ...
         <TextFieldAction value={firstField} setValue={setFirstField} type="password" message={"Enter your new password"} />

         {/* Display a second text field */}
         <TextFieldAction value={secondField} setValue={setSecondField} type="password" message={"Confirm your new password"} />
   ...
   function validateSubmit() {
      ...
      if (firstField < 5 || secondField < 5) {
         props.setError("Password must contain at least 5 characters");
         return false;
      }

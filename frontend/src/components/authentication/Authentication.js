      ...
      <div className={AuthenticationCSS.wrapper}>
         ...
         <div className={AuthenticationCSS.auth_box}>
            <div className={AuthenticationCSS.toggle_buttons}>
               <div onClick={() => setSignInActive(false)} className={signInActive ? AuthenticationCSS.inactive : ''}>
                  <p>Sign up</p>
               </div>
               <div onClick={() => setSignInActive(true)} className={!signInActive ? AuthenticationCSS.inactive : ''}>
                  <p>Sign in</p>
               </div>
            </div>

...
for stop_pair in glob.glob("/home/team13/data/adjacent_stop_pairs_with_features/*"):
    ...
    logging.info(f"{stop_pair_df.shape[0]} rows for {stop_pair.split('/')[-1]}")
...
with open(f'/home/team13/model_output/linear_regression/linear_regression_{datetime.datetime.now()}.pickle', 'wb') as pickle_file:
